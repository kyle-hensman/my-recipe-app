  ...
  useEffect(() => {
    const checkIfSaved = async () => {
      try {
        ...
        // const isRecipeSaved = favorites.data.some((fav: any) => fav.recipeId === parseInt(recipeId as string));
  ...
  const handleToggleSave = async () => {
    ...
    try {
      ...
      if (isSaved) {
        ...
        const response = await fetch(`${API_URL}/favorites/${session.user.id}/${recipeId}`, {
          method: "DELETE",
        });
